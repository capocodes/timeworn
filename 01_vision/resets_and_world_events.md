...
- **Why:** **Rebuild challenge**, **weekly rebalance** window, **neighborhood ops** (shard count tuning on the boundary — [Player ↔ Server Cardinality](../04_systems/player_server_cardinality.md)).
- **Wipes:** **Base / plot layout** and **hub-tied** build progress.
- **Persists:** **`Bank vault`** — persistent storage **larger than** your **raid loadout**; contents **survive** the weekly hub wipe. (**Loadout** = what you take **into** the raid; see [Vault & Loadout](../04_systems/vault_and_loadout.md).)
...
*Related:* [Meta Loop](meta_loop_intent.md) (base + seasons summaries), [Player ↔ Server Cardinality](../04_systems/player_server_cardinality.md), [Vault & Loadout](../04_systems/vault_and_loadout.md), [Core Session Loop](core_extraction_loop.md), [Decision Log](../05_production/decisions.md).
