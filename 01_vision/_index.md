...
- **PvE enemies:** `../04_systems/enemies_future_robots.md` — robots from the future; salvage → tech craft.
- **Weapon tiers & attachments:** `../04_systems/weapons_loot_tiers.md`, `../04_systems/attachments_catalog.md`.
- **Base building (stub):** `../04_systems/base_building.md` — *Dune*-inspired; details later.
- **Server ↔ player / friends / solo:** `../04_systems/player_server_cardinality.md` (exploration; ties to `scale_and_unresolved.md`).
- **`scale_and_unresolved.md`** — Map size, base vs raid time split, server / player cardinality — **decide explicitly**.
