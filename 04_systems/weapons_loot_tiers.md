# Weapons — era baseline & loot tiers *(DECISION)*
...
| Tier | Color | Weapon identity |
|------|--------|-------------------|
| 1 | **Grey** | Baseline period arms. |
| 2 | **Green** | Improved period / light modification. |
| 3 | **Blue** | Strong period or hybrid touches. |
| 4 | **Pink** | High-end hybrid / advanced period-future mix. |
| 5 | **Yellow** (legendary) | **Only** tier where the **weapon itself** is **fully from the future** — whole-gun anachronism, not just a part. |

**DECISION:** **Yellow** is the **exclusive** home for **fully future** **base weapons**. Lower tiers remain **mostly** **1850–70** in **identity** even if **attachments** add future tech on top.
